package stepDefinition;import static org.junit.Assert.assertEquals;
...
public class Stepsof_Featurefile extends BaseClass {
	WebDriver driver;
	...
	public Stepsof_Featurefile(BaseClass base) {
